...
<div class="block-cta" style="width: 100%; display: flex; justify-content: center!important; align-items: center!important; margin-top: 15px; <?php if($block): ?><?= $block->container_custom_css() ?><?php endif; ?>">
